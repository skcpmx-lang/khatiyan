...
class LoanMathTest {
    ...
    fun zeroRateGivesZeroInterest() {
        assertEquals(0L, LoanMath.flatInterestPaisa(1_000_000L, 0, LocalDate.of(2024, 1, 1), LocalDate.of(2025, 1, 1)))
        assertEquals(0L, LoanMath.flatInterestPaisa(0L, 1200, LocalDate.of(2024, 1, 1), LocalDate.of(2025, 1, 1)))
    }
}
